    ...
    def web_setup(self):
        ...
        try:
            ...
            if browserType=="Firefox":
                binary = FirefoxBinary(self.cf.get_conf_data(CONF_BRO_PATH)[CONF_FIR_PATH_NAME])
                fp=webdriver.FirefoxProfile(self.cf.get_conf_data(CONF_BRO_PATH)[CONF_FIR_PROFILE])
                driver=webdriver.Firefox(firefox_binary=binary,firefox_profile=fp)
                return driver
            elif browserType=="Chrome":
                option = webdriver.ChromeOptions()
                option.add_argument(self.cf.get_conf_data(CONF_BRO_PATH)[CONF_CHRO_PATH_NAME])
